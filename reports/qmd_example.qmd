...
The R programming language (R Core Team, 2019) [@R]
...
*Note: this report is adapted from Timbers [@ttimbers-horses] (2020).*

## Results

![](../results/horse_pops_plot.png){#fig-horse_plot fig-cap="Horse populations for all provinces in Canada from 1906 - 1972" width=80%}

@fig-horse_plot: Horse populations for all provinces in Canada from 1906 - 1972.
...
Additionally, note that in @tbl-horse_sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_plot.

![](../results/horse_pop_plot_largest_sd.png){#fig-horse_largest_sd width=60%}

@fig-horse_largest_sd: Horse populations for the province with the largest standard deviation

In @fig-horse_largest_sd we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
